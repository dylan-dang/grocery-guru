...
export function Card({
    item: { image, link, price, title, source },
    hightlight,
}: {
    item: Item;
    hightlight?: boolean;
    ...
    return (
        <a
            href={link}
            className={`${
                hightlight ? 'border-4 border-blue-400' : ''
            } mx-5 mt-10 flex flex-col items-center border rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-700 border-gray-700 bg-gray-800`}
        >
            <img
