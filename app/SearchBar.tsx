...
export function Card({src, href, title, desc}: CardProps) {
  return <a href={href} className="mt-10 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
...
function LoadingIcon() {
  return <div className="p-10 mt-10 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
...
export function SearchForm() {
  ...
  return <>
  <form className="mt-5 w-[50%]" onSubmit={async (event) => {
    setItem('loading');
  ...
  {item ? 
    ...
    <Card src={item.product.main_image} href={item.product.link} title={item.product.title} desc={`$${item.offers.primary.price}`}/>
   : null}
  </>;
}